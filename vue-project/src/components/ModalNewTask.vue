...
//We construct a new date object and we reformat it
...
//Main function to add new tasks
...
@media (max-width: 768px) {
  ...
  #modal-new-task form input:focus,
  #modal-new-task form select:focus {
    outline: none;
    border: 3px solid rgba(59, 126, 195, 1);
    background-color: rgb(239, 247, 255);
  }

  #modal-new-task form textarea {
    width: 100%;
    height: auto;
    text-align: center;
    border: none;
  ...
  #modal-new-task form textarea:focus {
    outline: none;
    border: 3px solid rgba(59, 126, 195, 1);
    background-color: rgb(239, 247, 255);
  }
